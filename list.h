...
struct Node_s
{
    ...
    struct Node_s *next_pointer;
    struct Node_s *previous_pointer;
    void *Item;
    struct Node_s *next_free_node;
};
...
struct List_s
{
    ...
    Node *head_node_pointer;
    Node *tail_node_pointer;
    int list_size;
    struct List_s *next_free_list;
    enum ListOutOfBounds state_curr_pointer;
};
